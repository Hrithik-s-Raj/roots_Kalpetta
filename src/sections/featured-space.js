...
import img5 from "assets/slides/5.jpg";
// import img6 from "assets/slides/06.jpg";
...
const FeaturedSpace = () => {
  ...
  return (
    <Box id="about" as="section" sx={styles.section}>
      <Container>
        <h1 className="treatments_head"> Treatments</h1>
